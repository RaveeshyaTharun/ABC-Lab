...
function Login() {
  ...
  async function login(event) {
    ...
    //console.log("message Raveeshya 1")
    try {
     ...
     // console.log("message Raveeshya 2",response.data)

      console.log(response.data);
      if (response.data.message === "Email not exists") {

      //  console.log("message Raveeshya 3")
        alert("Email does not exist");
      } else if (response.data.message === email) {
        // Check if the user is an admin

        //console.log("message Raveeshya 4")
        ...
        console.log("message Raveeshya 5")
    ...
    // }
      ...
      console.error(error);
      console.log("message Raveeshya 6",error.response)
